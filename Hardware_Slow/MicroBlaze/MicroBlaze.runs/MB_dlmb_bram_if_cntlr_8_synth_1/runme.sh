...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware/MicroBlaze/MicroBlaze.runs/MB_dlmb_bram_if_cntlr_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_dlmb_bram_if_cntlr_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_dlmb_bram_if_cntlr_8.tcl
