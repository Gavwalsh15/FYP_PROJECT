...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware/MicroBlaze/MicroBlaze.runs/MB_microblaze_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_microblaze_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_microblaze_0_6.tcl
