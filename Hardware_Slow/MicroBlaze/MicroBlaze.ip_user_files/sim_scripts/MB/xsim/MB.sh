...
simulate()
{
  xsim MB -key {Behavioral:sim_1:Functional:MB} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0306.protoinst" -protoinst "protoinst_files/MB.protoinst" -log simulate.log
}
