...
slope_uart, intercept_uart, _, _, std_err_uart = stats.linregress(df_uart['Size (bytes)'], df_uart['Transfer Time (s)'])
...
slope_comp, intercept_comp, _, _, std_err_comp = stats.linregress(df_computer['Size (bytes)'], df_computer['Transfer Time (s)'])
...
if SHOW_MB_STATS:
    ...
    slope_MB, intercept_MB, _, _, std_err_MB = stats.linregress(df_MB['Size (bytes)'], df_MB['Transfer Time (s)'])
