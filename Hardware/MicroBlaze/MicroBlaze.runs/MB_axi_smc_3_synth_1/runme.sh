...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware/MicroBlaze/MicroBlaze.runs/MB_axi_smc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_axi_smc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_axi_smc_3.tcl
