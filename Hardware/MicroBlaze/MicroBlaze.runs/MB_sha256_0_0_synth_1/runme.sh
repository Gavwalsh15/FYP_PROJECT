...
HD_PWD='C:/Viv/Hardware/MicroBlaze/MicroBlaze.runs/MB_sha256_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_sha256_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_sha256_0_0.tcl
