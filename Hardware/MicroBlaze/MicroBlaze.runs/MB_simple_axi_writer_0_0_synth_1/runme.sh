...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware/MicroBlaze/MicroBlaze.runs/MB_simple_axi_writer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_simple_axi_writer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_simple_axi_writer_0_0.tcl
