...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware/MicroBlaze/MicroBlaze.runs/MB_lmb_bram_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_lmb_bram_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_lmb_bram_8.tcl
