...
#
# Script generated by Vivado on Fri Apr 25 17:20:55 +0100 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MB xil_defaultlib.MB xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MB -key {Behavioral:sim_1:Functional:MB} -tclbatch cmd.tcl -protoinst "protoinst_files/MB.protoinst" -log simulate.log
}
