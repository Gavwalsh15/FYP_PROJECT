...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../MicroBlaze.gen/sources_1/bd/MB/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../MicroBlaze.gen/sources_1/bd/MB/ipshared/3242" \
