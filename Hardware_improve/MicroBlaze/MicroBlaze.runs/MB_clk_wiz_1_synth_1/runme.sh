...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware/MicroBlaze/MicroBlaze.runs/MB_clk_wiz_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_clk_wiz_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_clk_wiz_1.tcl
