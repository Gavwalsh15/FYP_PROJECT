...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware_improve/MicroBlaze/MicroBlaze.runs/synth_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_wrapper.tcl
