...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware/MicroBlaze/MicroBlaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MB_wrapper.tcl -notrace
