...
HD_PWD='C:/Users/gavwa/Desktop/Workin_Dir/Hardware_improve/MicroBlaze/MicroBlaze.runs/MB_uart_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_uart_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_uart_0_0.tcl
